        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('Crear Usuarios') }}</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="password" placeholder="{{ __('Contraseña') }}" name="password" value="{{ old('password') }}" required />
                    </div>
                    <div class="form-group">
