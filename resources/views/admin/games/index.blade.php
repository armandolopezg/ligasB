        ...
        <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.games.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Crear Partido') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $game->id }}">
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form onclick="return confirm('¿Estas seguro?')"  class="d-inline" action="{{ route('admin.games.destroy', $game->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
                            ...
                            @empty
                            <tr>
                                <td colspan="8" class="text-center">{{ __('Vaciar Datos') }}</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
