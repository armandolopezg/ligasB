        ...
        <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.players.create') }}" class="btn btn-primary">
                        ...
                        <span class="text">{{ __('Registrar Jugador') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $player->id }}">
                                ...
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form onclick="return confirm('¿Estás Seguro? ')"  class="d-inline" action="{{ route('admin.players.destroy', $player->id) }}" method="POST">
                                        @csrf
                                        @method('delete')
